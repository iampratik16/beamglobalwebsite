...
export const careers = {
  ...
  values: [
    {
      label: "Build trust",
      text: "We earn confidence through transparency, honesty and consistently delivering on what we promise.",
    },
    {
      label: "Pursue excellence",
      text: "We continually sharpen our expertise to stay at the forefront of the GRC industry.",
    },
    {
      label: "Stay client-centric",
      text: "We tailor every engagement to the unique needs and goals of the people we serve.",
    },
    {
  ...
  cta: {
    heading: "Ready to shape what's next?",
    body: "We're always glad to hear from talented people. Send us a note and tell us where you'd like to make an impact.",
    button: "Get in touch",
  },
};
